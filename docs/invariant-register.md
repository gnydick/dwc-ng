...
**Totals:** 120 invariants · 98 at rung 6 or above · 22 below rung 6 (ceiling 22).
...
`packages/ui/src/shell/panelCanvas.ts:108`
...
`packages/ui/src/shell/panelCanvas.ts:1082`
...
`packages/ui/src/shell/panelCanvas.ts:1094`
