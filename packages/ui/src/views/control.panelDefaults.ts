...
export const CONTROL_PANEL_DEFAULTS: PanelDefault[] = [
	...
	{ id: "filament", col: 12, row: 60, colSpan: 12, rowSpan: 50 },
	{ id: "heaters", col: 0, row: 78, colSpan: 12, rowSpan: 58 },
	{ id: "movement", col: 12, row: 110, colSpan: 12, rowSpan: 117 },
	...
	// has nowhere to go.
	{ id: "atx", col: 12, row: 227, colSpan: 12, rowSpan: 28 },
	{ id: "console", col: 0, row: 273, colSpan: 24, rowSpan: 75 },
	{ id: "camera", col: 0, row: 348, colSpan: 8, rowSpan: 75 },
];
